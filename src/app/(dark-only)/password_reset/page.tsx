...
export default function PasswordResetPage() {
  ...
  return (
    <div className="flex h-screen">
      <div className="bg-right-[20vh] flex h-full w-full flex-col overflow-hidden bg-neutral-950 bg-linear-to-r bg-[url('/assets/reset-password-orb.webp')] from-neutral-950 from-70% to-neutral-900 bg-position-[60vw] bg-no-repeat">
