    ...
    <>
      ...
      >
        <div className="flex flex-col items-center mb-8 text-white">
          <svg
            aria-label="Outerbase Logo"
            fill="currentColor"
            viewBox="75 75 350 350"
            className="mb-2 w-14 h-14 text-black dark:text-white"
          >
            <title>Outerbase Logo</title>
        ...
        <div className="mt-4 text-sm text-center text-neutral-400">
          ...
          <Link
            className="transition ease-in-out delay-75 text-neutral-300 hover:text-neutral-100"
            href={"/signup"}
          >
            Sign Up
          </Link>
