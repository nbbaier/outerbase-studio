      ...
      >
        <div className="mb-8 flex flex-col items-center text-white">
          <svg
            ...
            aria-label="Verify Page Logo"
          >
            <title>Verify Page Logo</title>
          ...
          <h1 className="text-2xl font-bold">Verify that it&apos;s you</h1>
          <p className="text-center text-base text-neutral-300">
            Enter the verification code for Outerbase from your two-factor
            authentication app.
          </p>
        </div>
